	...
	<div class="row">
		<div class="column">
			...
			<i> Home insurance, also commonly called hazard insurance or
				...
				home or mutiple unit buildings It is an insurance policy that
				combines various personal insurance protections which can include
				losses ocurring to one's home, its contents, loss of use (additional
				living expenses), or loss of other personal possessions of the
				homeowner; as well as liablitity insurance for accidents that may
				happen at the home or at the hands of the homeowner within the
				policy territory. If a home does not meet the underwriting fuidlines
