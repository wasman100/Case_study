...
@tag
Feature: Registering into home insurance site
  I should be able to navigate to home insurance site and register

  @tag1
  Scenario: I am registering into home insurance sit 
